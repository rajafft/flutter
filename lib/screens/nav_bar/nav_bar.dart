...
class TopBorderNavBarEdit extends StatelessWidget {
  const TopBorderNavBarEdit({
    Key? key,
    required this.items,
    this.currentIndex = 0,
    this.onTap,
  ...
  final List<TopBorderNavBarItemEdit> items;
                              ...
                              child: Padding(
                                ...
                                child: DefaultTextStyle(
                                    ...
                                    child: Container(
                                      ...
                                      width: 25,
                                      height: 3,
                                      color: dotIndicatorColor ?? _selectedColor,
                                    )
...
/// A tab to display in a [TopBorderNavBarEdit]
class TopBorderNavBarItemEdit {
  /// An icon to display.
  final Widget icon;
